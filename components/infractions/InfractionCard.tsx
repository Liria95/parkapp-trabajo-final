...
const EstadoBadge = styled.View<{ estado: string }>`
  background-color: ${props => {
    switch (props.estado) {
      ...
      case 'cancelada': return colors.yellow;
...
const getBackgroundColor = (estado: string): string => {
  switch (estado) {
    ...
    case 'pagada': return '#E8F5E8';
    case 'cancelada': return '#FFF8E1';
  ...
  return (
    ...
    >
      ...
      <CardBody>
        <DetailRow>
          <DetailIcon>
            <Ionicons name={getIconName('patente')} size={getResponsiveSize(16)} color={colors.primary} />
          </DetailIcon>
          <DetailContent>
        ...
        <DetailRow>
          <DetailIcon>
            <Ionicons name={getIconName('motivo')} size={getResponsiveSize(16)} color={colors.primary} />
          </DetailIcon>
          <DetailContent>
        ...
        <DetailRow>
          <DetailIcon>
            <Ionicons name={getIconName('monto')} size={getResponsiveSize(16)} color={colors.primary} />
          </DetailIcon>
          <DetailContent>
        ...
        <DetailRow>
          <DetailIcon>
            <Ionicons name={getIconName('fecha')} size={getResponsiveSize(16)} color={colors.primary} />
          </DetailIcon>
          <DetailContent>
        ...
        <DetailRow>
          <DetailIcon>
            <Ionicons name={getIconName('ubicacion')} size={getResponsiveSize(16)} color={colors.primary} />
          </DetailIcon>
          <DetailContent>
      ...
      <CardFooter>
        <GestionarButton estado={infraccion.estado} onPress={() => onPress(infraccion)}>
          <Ionicons name="settings" size={getResponsiveSize(16)} color={colors.white} />
