  ...
  return (
    ...
    <Tab.Navigator
        screenOptions={({ route }) => ({
            ...
            tabBarActiveTintColor: colores.AZUL_PRINCIPAL,
            tabBarInactiveTintColor: colores.NEGRO,
        ...
        {estacionamiento?.activo && (
            <Tab.Screen
                ...
                tabBarIcon: ({ color, size }) => (
                    ...
                    easing="ease-out"
                    >
                    <Ionicons name="car-sport-outline" size={size + 5} color={colores.ROJO_PELIGRO} />
                    </Animatable.View>
                ),
                }}
            />
