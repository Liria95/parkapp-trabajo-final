    ...
    <Header>
      {showBackButton && onBackPress && (
        <HeaderButton onPress={onBackPress}>
          <Ionicons name="arrow-back" size={getResponsiveSize(20)} color={theme.colors.white} />
        </HeaderButton>
      )}
      ...
      {onRightPress && (
        <HeaderButton onPress={onRightPress}>
          <Ionicons name={rightIconName as any} size={getResponsiveSize(20)} color={theme.colors.white} />
        </HeaderButton>
      )}
    </Header>
  );
